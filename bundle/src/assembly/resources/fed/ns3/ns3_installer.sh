...
ns3_federate_url="https://github.com/hoelger/ns3-federate/archive/refs/heads/1033-use-wifi-not-wave.zip" # TODO: bump to /refs/tags/25.1.zip before next release
